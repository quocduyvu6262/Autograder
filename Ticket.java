 ...
 * This file contains the Ticket class, which an implementation
 * for the ticket in the Auto Grader System. The Autograder’s 
 * MyPriorityQueue contains elements of type Ticket.
 */
...
public class Ticket implements Comparable<Ticket>{
    ...
    /**
     * TODO: Method Header
     * Compare two tickets by the order value of ticketType 
     * (can be found from the orderMap) and then, createdAt.
     * @param other - the other ticket to be compared with
     * @return a positive value if current object 
     * numerically  comes after Ticket other.
     * Returns a negative value if current object 
     * numerically comes before Ticket other.
     * Returns 0 if order values of ticketType and 
     * createdAt for both current object and Ticket 
